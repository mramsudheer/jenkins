...
**Jenkins Pipeline = AWS CodePipeline + AWS CodeBuild**
Explanation: Just like GitHub Actions, a single Jenkins server handles both the pipeline structure (Jenkinsfile) and runs the actual build jobs on its nodes.
