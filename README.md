# jenkins
1.&emsp;**GitHub = AWS CodeCommit** <br>
&emsp;Both are hosted Git repositories where you store your source code.<br><br>
...
3.&emsp;**Jenkins Pipeline = AWS CodePipeline + AWS CodeBuild** <br>
